...
type VaccineApplication struct {
	...
	// json:"-" para no serializar la relación inversa y evitar datos redundantes.
	HealthRecord HealthRecord `json:"-" gorm:"foreignKey:HealthRecordID;constraint:OnDelete:CASCADE"`
}
