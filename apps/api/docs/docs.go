...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v1/health-catalogs/species/{species}": {
            "get": {
                "security": [
                    {
                        "CookieAuth": []
        ...
        "/api/v1/pets/{pet_id}/health-records": {
            "get": {
                "security": [
                    {
                        "CookieAuth": []
        ...
        "/api/v1/pets/{pet_id}/health-records/{id}": {
            "get": {
                "security": [
                    {
                        "CookieAuth": []
        ...
        "/api/v1/pets/{pet_id}/health-records/{id}/status": {
            "patch": {
                "security": [
                    {
                        "CookieAuth": []
