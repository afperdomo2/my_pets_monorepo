...
const category = HealthCatalogCategory.Vaccine
    ...
    <div class="modal-backdrop" @click.self="emit('close')">
      <div class="modal-container">
        <div class="modal-header">
          <h2>{{ isEditing ? 'Editar vacuna' : 'Registrar vacuna' }}</h2>
                ...
                <div class="suggestion-header">
                  <p class="suggestion-text">
                    ...
                    <template v-if="selectedCatalog?.frequency_months">
                      <br>Esta vacuna se aplica cada <strong>{{ selectedCatalog.frequency_months }} meses</strong>.
                    </template>
                  </p>
